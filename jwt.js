...
var i = 'LDB'; // Issuer (Software organization who issues the token)
var s = 'LDB'; // Subject (intended user of the token)
var a = 'http://ldblao.la'; // Audience (Domain within which this token will live and function)
